...
const Skills = () => {
  ...
  const SkillTag = ({
    ...
    >
      ...
      <div
        className={`absolute inset-0 rounded-xl bg-gradient-to-r ${categoryColor} opacity-0 hover:opacity-20 transition-opacity duration-300 -z-10 blur-sm`}
      ></div>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
          {skillCategories.map((category, categoryIndex) => (
            ...
            >
              ...
              >
                <div
                  className={`absolute inset-0 rounded-3xl bg-gradient-to-r ${category.color} opacity-0 transition-opacity duration-500 ${
                    hoveredCategory === categoryIndex ? "opacity-20" : ""
                  } blur-sm -z-10`}
                ></div>
                ...
                <div className="flex items-center gap-4 mb-8">
                  <div
                    className={`p-4 rounded-2xl bg-gradient-to-r ${category.color} shadow-lg group-hover:scale-110 transition-transform duration-300`}
                  >
                  ...
                  <div>
                    ...
                    <div
                      className={`w-16 h-1 bg-gradient-to-r ${category.color} rounded-full mt-2 group-hover:w-24 transition-all duration-300`}
                    ></div>
                  </div>
                </div>
                  ...
                  <div className="flex items-center gap-2 mt-6 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                    ...
                    <div className="flex-1 h-2 bg-white/10 rounded-full overflow-hidden">
                      <div
                        ...
                        style={{
                          width: hoveredCategory === categoryIndex ? "85%" : "0%",
                        }}
                      ></div>
                    </div>
