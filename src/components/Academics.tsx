          ...
          <div className="flex items-start gap-4 mb-6">
            ...
            <div className="flex-1">
              <div className="flex items-center gap-3 mb-2">
                <h4 className="text-xl font-bold text-white">{type === 'education' ? item.degree : item.title}</h4>
                {item.status === 'current' && (
              ...
              <p className="text-blue-300 font-semibold text-lg">{type === 'education' ? item.institution : item.company}</p>
